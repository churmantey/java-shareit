...
public class ItemRequestControllerTests {
    ...
    public void setUp() {
        ...
        requestDto3.setId(3L);
        requestDto3.setDescription("item request #3 description");
        requestDto3.setAuthor(userDto2.getId());
        requestDto3.setCreated(LocalDateTime.now());
    ...
    public void createItemRequestTest() throws Exception {
        when(requestService.createItemRequest(anyLong(), any(NewItemRequestDto.class)))
    ...
    public void getUserItemRequestsTest() throws Exception {
        when(requestService.getUserItemRequests(anyLong()))
                .thenReturn(Arrays.asList(requestDto, requestDto2));
    ...
    public void getOtherItemRequestsTest() throws Exception {
        when(requestService.getOtherItemRequests(anyLong()))
                .thenReturn(Arrays.asList(requestDto, requestDto2));
