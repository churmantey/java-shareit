...
public class BookingControllerTests {
    ...
    public void createBookingTest() throws Exception {
        when(bookingClient.bookItem(anyLong(), any(NewBookingDto.class)))
    ...
    public void getUserBookingsByStateTest() throws Exception {
        when(bookingClient.getBookings(anyLong(), any(BookingSearchStates.class), anyInt(), anyInt()))
                .thenReturn(ResponseEntity.ok(Arrays.asList(bookingDto, bookingDto2)));
    ...
    public void getOwnerBookingsByStateTest() throws Exception {
        when(bookingClient.getOwnerBookingsByState(anyLong(), anyString()))
                .thenReturn(ResponseEntity.ok().body(Arrays.asList(bookingDto, bookingDto2)));
